...
#create a set
flow transactions send ./cadence/transactions/admin/create_set.cdc --signer emulator-account --network=emulator "Beam Test" nil nil

#read the set data
flow scripts execute ./cadence/scripts/get_set_data.cdc --network=emulator 1

#create a collectible
flow transactions send ./cadence/transactions/admin/create_collectible_item.cdc --signer emulator-account --network=emulator "Beam Collectible Name" "This is a sample Beam Collectible." "https://image.shutterstock.com/image-vector/sample-stamp-grunge-texture-vector-260nw-1389188336.jpg" "<image/jpeg>" "https://kotd.niftory.com/" []
